...
CREATE TABLE IF NOT EXISTS { { ledgers } } (
    ...
    `fiscal_yr_id` INT(11) DEFAULT NULL COMMENT 'fiscal period the ledger applies to',
    ...
    FOREIGN KEY (`fiscal_yr_id`) REFERENCES { { fiscal_period } } (`fiscal_yr_id`) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (`owner`) REFERENCES `borrowers` (`borrowernumber`)
) ENGINE = INNODB;
...
CREATE TABLE IF NOT EXISTS { { funds } } (
    ...
    `fiscal_yr_id` INT(11) DEFAULT NULL COMMENT 'fiscal period the fund applies to',
...
CREATE TABLE IF NOT EXISTS { { sub_funds } } (
    ...
    `fiscal_yr_id` INT(11) DEFAULT NULL COMMENT 'fiscal period the sub_fund applies to',
...
CREATE TABLE IF NOT EXISTS { { fund_allocation } } (
    ...
    `fiscal_yr_id` INT(11) DEFAULT NULL COMMENT 'fiscal period the fund allocation applies to',
