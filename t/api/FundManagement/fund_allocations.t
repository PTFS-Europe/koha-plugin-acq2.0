...
subtest 'list() tests' => sub {
    ...
    $t->get_ok("//$userid:$password@/api/v1/contrib/acquire/fund_allocations")->status_is(200)->json_is( [] );
    ...
    $t->get_ok("//$userid:$password@/api/v1/contrib/acquire/fund_allocations")->status_is(200)->json_is( '/0/currency' => $fund_allocation->currency )->json_is( '/0/reference' => $fund_allocation->reference );
    ...
    $t->get_ok("//$userid:$password@/api/v1/contrib/acquire/fund_allocations")->status_is(200)
    ...
    $t->get_ok(qq~//$userid:$password@/api/v1/contrib/acquire/fund_allocations?q=[{"me.reference":{"like":"%ko%"}}]~)->status_is(200)
        ->json_is( [] );
    ...
    $t->get_ok("//$userid:$password@/api/v1/contrib/acquire/fund_allocations?blah=blah")->status_is(400)
...
subtest 'get() tests' => sub {
    ...
    $t->get_ok( "//$userid:$password@/api/v1/contrib/acquire/fund_allocations/" . $fund_allocation->fund_allocation_id )->status_is(200)
        ->json_is( $fund_allocation->to_api );

    # Attempt to get non-existent fund_allocations
    my $non_existent_fund_allocations = $builder->build_object( { class => 'Koha::Acquire::Funds::FundAllocations' } );
    my $non_existent_id      = $non_existent_fund_allocations->fund_allocation_id;
    $non_existent_fund_allocations->delete;

    $t->get_ok("//$userid:$password@/api/v1/contrib/acquire/fund_allocations/$non_existent_id")->status_is(404)
...
subtest 'add() tests' => sub {
    ...
    my $fund = $builder->build_object( { class => 'Koha::Acquire::Funds::Funds' } );
    ...
    my $fund_allocation_id =
        $t->post_ok( "//$userid:$password@/api/v1/contrib/acquire/fund_allocations" => json => $fund_allocation )
        ->status_is( 201, 'SWAGGER3.2.1' )->header_like(
        Location => qr|^/api/v1/contrib/acquire/fund_allocations/\d*|,
        'SWAGGER3.4.1'
        ...
        ->json_is( '/visible_to'  => $fund_allocation->{visible_to} )->tx->res->json->{fund_allocation_id};
...
subtest 'delete() tests' => sub {
    ...
    my $fund_allocation_id = $builder->build_object( { class => 'Koha::Acquire::Funds::FundAllocations' } )->fund_allocation_id;

    # Delete existing fund_allocations
    $t->delete_ok("//$userid:$password@/api/v1/contrib/acquire/fund_allocations/$fund_allocation_id")->status_is( 204, 'SWAGGER3.2.4' )
        ->content_is( '', 'SWAGGER3.3.4' );

    # Attempt to delete non-existent fund_allocations
    $t->delete_ok("//$userid:$password@/api/v1/contrib/acquire/fund_allocations/$fund_allocation_id")->status_is(404);
